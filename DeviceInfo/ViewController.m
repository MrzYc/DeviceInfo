...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        case 0:
            self.infoLab.text = [ZYCDeviceInfo ZYC_getDeviceIDFV];
            break;
        case 1:
            self.infoLab.text = [ZYCDeviceInfo ZYC_getDeviceIDFA];
            break;
        case 2:
            self.infoLab.text = [ZYCDeviceInfo ZYC_getDeviceIMEI];
            break;
        case 3:
            self.infoLab.text = [ZYCDeviceInfo ZYC_getDeviceMAC];
            break;
        case 4:
            self.infoLab.text = [ZYCDeviceInfo ZYC_getDeviceUUID];
            break;
        case 5:
            self.infoLab.text = [ZYCDeviceInfo ZYC_getDeviceUDID];
            break;
        default:
            break;
    }
